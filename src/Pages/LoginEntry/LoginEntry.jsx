...
const LoginEntry = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row bg-[#FCFCFC] relative">
            <div className="lg:flex hidden items-center justify-center w-full max-w-[675px]">
            ...
            <div className="lg:relative absolute lg:top-0 top-6 w-full">
                ...
                <div className="lg:w-full lg:py-9 lg:px-10 py-6 px-6  bottom-[90px] bg-[#FCFCFC] h-full relative lg:mx-0 mx-[16px] lg:rounded-0 rounded-[16px]">
                    <div className="text-center lg:flex hidden justify-end">
                        <img src={logo} alt="Logo" />
                    </div>

                    <div className="w-full max-w-[508px] mx-auto h-full flex items-center">
                        <div className="w-full">
                            <div className="mb-[80px] lg:block hidden">
                            ...
                            <div className="flex justify-center mb-9">
                                <button
                                    ...
                                    className={`py-2 text-xl w-full ${isLoginTab
                                ...
                                >
                                    {() => (
                                        <Form>
                                            ...
                                            <div className="w-full flex lg:flex-row flex-col items-center justify-center lg:gap-12 gap-[20px] text-xl lg:mt-20 mt-10">
                                                <button
                                                    type="submit"
